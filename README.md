...
For example, you want to update the game from 2.2.0 to 2.3.0:

1. Make sure you have extracted all files from the `game_2.2.0_2.3.0_hdiff.zip` and `en-us_2.2.0_2.3.0_hdiff.zip`, then replace them in the `2.2.0` game client directory.
2. Place the following files in the same folder as `GenshinImpact.exe`:
   - `hdiffz.exe`
   - `hpatchz.exe`
   - `Start.bat`
   - `Cleanup_2.2.0-2.3.0.txt`
   - `AudioPatch_Common_2.2.0-2.3.0.txt`
   - `AudioPatch_English_2.2.0-2.3.0.txt`
   - `AudioPatch_Japanese_2.2.0-2.3.0.txt`
   - `AudioPatch_Chinese_2.2.0-2.3.0.txt`
   - `AudioPatch_Korean_2.2.0-2.3.0.txt`
3. Run `Start.bat` and wait until the process finishes.
4. Now, your game is updated to version `2.3.0`.
